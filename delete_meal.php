    ...
    <div class="row min-vh-100 justify-content-center align-items-center">
      <div class="col-lg-5">
        ...
        <div class="form-wrap border rounded p-4">
          <h1>Delete Meal</h1>
          <p>Delete meal to edit</p>
          <!-- form starts here -->
          <form action="./delete_meal_final.php" method="post" novalidate>
            <div class="mb-2">
            ...
            <div class="mb-3">
              ...
              <input type="submit" class="btn btn-danger form-control" id="edit_meal_select_submit" name="submit" value="Delete Meal">
            </div>
